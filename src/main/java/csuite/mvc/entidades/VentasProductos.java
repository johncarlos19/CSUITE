...
import  csuite.mvc.servicios.VentasProductosServicios;
...
public class VentasProductos  implements Serializable {
    ...
    private List<ProductoComprado> listaProducto;
    ...
    public List<ProductoComprado> getListaProducto() {
        return listaProducto;
    }

    public void setListaProducto(List<ProductoComprado> listaProducto) {
