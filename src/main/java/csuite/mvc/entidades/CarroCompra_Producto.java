...
public class CarroCompra_Producto implements Serializable {
    ...
    @EmbeddedId
    private csuite.mvc.entidades.CarrocompraProductoId id;
...
//    }
    ...
    public csuite.mvc.entidades.CarrocompraProductoId getId() {
        return id;
    }

    public void setId(csuite.mvc.entidades.CarrocompraProductoId id) {
        this.id = id;
    }
