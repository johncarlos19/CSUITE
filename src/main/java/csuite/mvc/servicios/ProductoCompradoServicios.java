...
public class ProductoCompradoServicios extends GestionadDB<ProductoComprado> {
    ...
    private static ProductoCompradoServicios instancia;



    public static ProductoCompradoServicios getInstancia(){
        if(instancia==null){
            instancia = new ProductoCompradoServicios();
        }
        return instancia;
    }
    ...
    public ProductoComprado addProductoComprado(ProductoComprado productoComprado) {
        return (ProductoComprado) crear(productoComprado);
    }
